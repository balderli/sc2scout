...
class ZerglingScoutImgFeatureLocal(ImgFeatExtractor):
    def __init__(self, compress_width, local_width, reverse):
        super(ZerglingScoutImgFeatureLocal, self).__init__(compress_width, reverse)
        self._local_width = local_width
        self._channel_num = LOCAL_CHANNEL

    def reset(self, env):
        super(ZerglingScoutImgFeatureLocal, self).reset(env)
    ...
    def extract(self, env, obs):
        ...
        #self.save_map(height_map, 'local_map.bmp')
