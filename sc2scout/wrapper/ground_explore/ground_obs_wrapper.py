...
from sc2scout.wrapper.feature.ground_vec_feature import GroundVecFeature, GroundVecFeatureV1
...
class GroundImgObsWrapperV1(gym.ObservationWrapper):
    def __init__(self, env):
        super(GroundImgObsWrapperV1, self).__init__(env)
        self._global = GroundImgFeature()
