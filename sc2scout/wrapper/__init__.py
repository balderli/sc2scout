...
from sc2scout.wrapper.evade_enemy import EvadeMakerV0, EvadeMakerV1, \
    ZerglingEvadeMakerLocalV0, ZerglingEvadeMakerGlobalV0
...
register('zergling_evade_local_v0', ZerglingEvadeMakerLocalV0())
register('zergling_evade_global_v0', ZerglingEvadeMakerGlobalV0())
